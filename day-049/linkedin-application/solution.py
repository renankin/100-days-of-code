...
def abort_application():
    ...
    discard_button = driver.find_elements(
        by=By.CLASS_NAME,
        value="artdeco-modal__confirm-dialog-btn")[1]
...
driver.get(
    "https://www.linkedin.com/jobs/search/?currentJobId=3586148395&f_LF=f_AL"
    "&geoId=101356765&keywords=python&location=London%2C%20England%2C%20United"
    "%20Kingdom&refresh=true")
...
# Get Listings
time.sleep(5)
all_listings = driver.find_elements(by=By.CSS_SELECTOR,
